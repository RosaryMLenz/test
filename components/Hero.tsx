...
const Hero = ({ onBookClick }: HeroProps) => {
    ...
    return (
        <section
            className="relative bg-white text-black dark:bg-black dark:text-white flex items-center justify-center min-h-[85vh] pt-10 px-6 sm:px-8 transition-colors duration-300"
        >
